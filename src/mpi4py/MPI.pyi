...
class Grequest(Request):
    ...
    @classmethod
    def Start(cls, query_fn: Callable[..., None], free_fn: Callable[..., None], cancel_fn: Callable[..., None], args: Optional[Tuple[Any]] = None, kwargs: Optional[Dict[str, Any]] = None) -> Grequest: ...
...
class Group:
    ...
    @classmethod
    def Create_from_session_pset(cls, session: Session, pset_name: str) -> Group: ...
    def Free(self) -> None: ...
    def py2f(self) -> int: ...
    @classmethod
...
class Session:
    def __new__(cls, session: Optional[Session] = None) -> Session: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
    def __bool__(self) -> bool: ...
    @classmethod
    def Init(cls, info: Info = INFO_NULL, errhandler: Optional[Errhandler] = None) -> Session: ...
...
class Comm:
    ...
    def Clone(self) -> Self: ...
    def Dup(self, info: Optional[Info] = None) -> Self: ...
    def Dup_with_info(self, info: Info) -> Self: ...
    def Idup(self, info: Optional[Info] = None) -> Tuple[Self, Request]: ...
    ...
    def Isendrecv(self, sendbuf: BufSpec, dest: int, sendtag: int = 0, recvbuf: BufSpec = None, source: int = ANY_SOURCE, recvtag: int = ANY_TAG) -> Request: ...
    ...
    def Gather_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: Optional[BufSpecB], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Gatherv_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: Optional[BufSpecV], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Scatter_init(self, sendbuf: Optional[BufSpecB], recvbuf: Union[BufSpec, InPlace], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Scatterv_init(self, sendbuf: Optional[BufSpecV], recvbuf: Union[BufSpec, InPlace], root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Allgather_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecB, info: Info = INFO_NULL) -> Prequest: ...
    def Allgatherv_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpecV, info: Info = INFO_NULL) -> Prequest: ...
    def Alltoall_init(self, sendbuf: Union[BufSpecB, InPlace], recvbuf: BufSpecB, info: Info = INFO_NULL) -> Prequest: ...
    def Alltoallv_init(self, sendbuf: Union[BufSpecV, InPlace], recvbuf: BufSpecV, info: Info = INFO_NULL) -> Prequest: ...
    def Alltoallw_init(self, sendbuf: Union[BufSpecW, InPlace], recvbuf: BufSpecW, info: Info = INFO_NULL) -> Prequest: ...
    def Reduce_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: Optional[BufSpec], op: Op = SUM, root: int = 0, info: Info = INFO_NULL) -> Prequest: ...
    def Allreduce_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
    def Reduce_scatter_block_init(self, sendbuf: Union[BufSpecB, InPlace], recvbuf: Union[BufSpec, BufSpecB], op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
    def Reduce_scatter_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, recvcounts: Optional[Sequence[int]] = None, op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
...
class Intracomm(Comm):
    ...
    @classmethod
    def Create_from_group(cls, group: Group, stringtag: str = 'org.mpi4py', info: Info = INFO_NULL, errhandler: Optional[Errhandler] = None) -> Intracomm: ...
    ...
    def Scan_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
    def Exscan_init(self, sendbuf: Union[BufSpec, InPlace], recvbuf: BufSpec, op: Op = SUM, info: Info = INFO_NULL) -> Prequest: ...
...
class Intercomm(Comm):
    ...
    @classmethod
    def Create_from_groups(cls, local_group: Group, local_leader: int, remote_group: Group, remote_leader: int, stringtag: str = 'org.mpi4py', info: Info = INFO_NULL, errhandler: Optional[Errhandler] = None) -> Intracomm: ...
...
class Win:
    ...
    def __bool__(self) -> bool: ...
    @classmethod
    def Create(cls, memory: Union[Buffer, Bottom], disp_unit: int = 1, info: Info = INFO_NULL, comm: Intracomm = COMM_SELF) -> Win: ...
    @classmethod
...
class File:
    ...
    def __bool__(self) -> bool: ...
    @classmethod
    def Open(cls, comm: Intracomm, filename: Union[PathLike, str, bytes], amode: int = MODE_RDONLY, info: Info = INFO_NULL) -> File: ...
    def Close(self) -> None: ...
    @classmethod
    def Delete(cls, filename: Union[PathLike, str, bytes], info: Info = INFO_NULL) -> None: ...
...
class BottomType(int):
    def __new__(cls) -> BottomType: ...
    def __repr__(self) -> str: ...

@final
class InPlaceType(int):
    def __new__(cls) -> InPlaceType: ...
    def __repr__(self) -> str: ...
...
class Pickle:
    ...
    def dumps_oob(self, obj: Any) -> Tuple[bytes, List[memory]]: ...
